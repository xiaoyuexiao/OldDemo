...
public class AchieveApriori {
	...
	public static void summary(Map<String,Integer> L1,Map<String,ArrayList<String>> data_record)
	{
		...
		//剪枝
		Map<String, Integer> map2 = AchieveApriori.Cut(10,L2);
	...
	public static void main(String[] args)
	{
		...
		try {
			 map = getDataFromExcel.getExcelContent();
		} catch (Exception e)
		{
			e.printStackTrace();
		}
		...
		//找到C1
		Map<String, Integer> L1 = AchieveApriori.getL1(map);
